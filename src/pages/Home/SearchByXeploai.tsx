...
const SearchByXeploai = () => {
  ...
  const onFinish = async (values: FormValues) => {
    ...
    try {
      ...
      const { xeploai } = values;

      const ids = await findByXeploai(contract, xeploai);
  ...
  return (
    <Layout>
      <Form form={form} layout={'vertical'} onFinish={onFinish}>
        <Form.Item label="Xếp loại" required={true} name={'xeploai'}>
...
export default SearchByXeploai;
